...
-- ============================================================================
-- PROBLEM:
-- CBT exam results are not automatically appearing in:
-- 1. Teacher scoresheets
-- 2. Results pages (admin/principal/headteacher)
-- 3. Student result pages
--
-- ROOT CAUSES:
-- 1. Trigger watches cbt_results table instead of cbt_submissions
-- 2. Results service queries cbt_test_scores instead of score_sheets
-- 3. score_sheets not reliably populated from cbt_submissions
--
-- SOLUTION:
-- 1. Fix trigger to listen to cbt_submissions instead of cbt_results
-- 2. Backfill all existing graded CBT submissions to score_sheets
-- 3. Ensure academic_session_id is properly populated
-- ============================================================================
...
SELECT
  ...
  gs.session_id,
  gs.session_year,
  -- Map scores to appropriate columns based on assessment_type
