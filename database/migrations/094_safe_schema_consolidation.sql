-- Migration 094: Safe Schema Consolidation
-- Simplified approach that works with Supabase PostgreSQL
-- Fixes assignments table and creates broadcasts infrastructure
...
-- ============================================================================
-- SUMMARY OF CHANGES:
-- ✅ Added teacher_id column to assignments table with FK constraint
-- ✅ Added file_path, file_name, file_size to assignments
-- ✅ Added status column to assignments
-- ✅ Added file_path, file_name, file_size to assignment_submissions
-- ✅ Added submission_status to assignment_submissions
-- ✅ Created broadcasts table for admin messaging
-- ✅ Created broadcast_read_status table for tracking read status
-- ✅ All indexes created for performance
-- ✅ All changes are safe (using IF NOT EXISTS)
-- ✅ Supabase PostgreSQL compatible (no information_schema.statistics)
-- ============================================================================
