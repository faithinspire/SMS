...
export default function SchoolAdminRegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.fullName || !formData.email || !formData.schoolId || !formData.password) {
    ...
    try {
      await AuthService.registerSchoolAdmin({
      ...
      setSuccess('✅ School Admin account created successfully!')
      setFormData({ fullName: '', email: '', schoolId: '', password: '', confirmPassword: '' })
      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-lg shadow-xl p-8">
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold text-gray-900">🏫 School Admin</h1>
