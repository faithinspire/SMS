...
export default function HeadteacherLessonNotesPage() {
  ...
  const loadLessonNotes = async () => {
    try {
      ...
      console.log('[HeadteacherLessonNotes] Loaded:', formattedNotes.length, 'notes')
    } catch (err: any) {
      console.error('[HeadteacherLessonNotes] Error:', err)
  ...
  const handleApproveNote = async () => {
    ...
    try {
      ...
      console.error('[HeadteacherLessonNotes] Approve error:', err)
      setError(err.message)
    } finally {
      setReviewing(false)
    }
              ...
              <div className="space-y-4">
                ...
                {selectedNote.file_name && (
                  <button
                    ...
                    className="w-full px-4 py-2 border border-purple-500 text-purple-600 rounded-lg font-semibold hover:bg-purple-50 transition-all text-sm"
                  >
                ...
                <button
                  ...
                  disabled={reviewing}
                  className="w-full px-4 py-2 bg-purple-600 text-white rounded-lg font-bold hover:bg-purple-700 disabled:opacity-50 transition-all"
                >
