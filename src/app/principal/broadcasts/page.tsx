...
export default function PrincipalBroadcastsPage() {
  ...
  const [recipientRole, setRecipientRole] = useState<'ALL' | 'TEACHER' | 'HEAD_TEACHER' | 'ACCOUNTANT' | 'STUDENT'>('ALL')
    ...
    <div className="min-h-screen bg-gradient-to-br from-amber-50 to-orange-50">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="bg-white rounded-lg shadow-lg p-6 mb-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">📢 Principal Announcements</h2>
          ...
          <div className="space-y-6">
            ...
            <button
              ...
              className="w-full px-6 py-3 bg-gradient-to-r from-amber-600 to-orange-600 text-white font-bold rounded-lg hover:from-amber-700 hover:to-orange-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all"
            >
          ...
          {broadcasts.length === 0 ? (
            ...
            <div className="space-y-4">
              {broadcasts.map((broadcast) => (
                <div key={broadcast.id} className="p-4 border border-gray-200 rounded-lg hover:border-amber-300 transition">
